defmodule Exercises.GoTour.LoopsAndFunctions do
  @moduledoc """
  From, https://go.dev/tour/flowcontrol/8.
  ...
  each z along the way. See how close you get to the answer for various values of x
  (1, 2, 3, ...) and how quickly the guess improves.
