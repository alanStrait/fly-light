  ...
  def read_machine_data do
    ...
    |> Stream.map(fn [
      ...
      %{
        ...
        http_path_username: http_path_username,
        http_auth_password: http_auth_password,
        wait_time: String.to_integer(wait_time),
        token: token,
        tls_config_address: tls_config_address,
        tls_config_ca_path: tls_config_ca_path,
        tls_config_ca_file: tls_config_ca_file,
        tls_config_cert_file: tls_config_cert_file,
        tls_config_key_file: tls_config_key_file,
        tls_config_insecure_skip_verify: tls_config_insecure_skip_verify,
        memory_total: String.to_integer(memory_total),
